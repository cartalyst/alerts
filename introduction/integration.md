...
The Alerts package has optional support for Laravel 4 and it comes bundled with a Service Provider and a Facade for easy integration.
...
`php artisan config:publish cartalyst/alerts`

This will publish the config file to `app/config/packages/cartalyst/alerts/config.php` where you can modify the package configuration.
